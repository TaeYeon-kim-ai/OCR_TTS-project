#Brings all the pieces together to perform rudimentary 
# R-CNN object detection, the key components being Selective 
# Search and classification (note that this script 
# does not accomplish true end-to-end R-CNN object 
# detection by means of a model with a built-in 
# Selective Search region proposal portion of the network)
