...
DEFAULT_LABEL_FILE = os.path.join(SCRIPT_PATH,
                                  'C:/final_project/FRCNN_HEW/labels/5888-common-hangul.txt')
DEFAULT_FONTS_DIR = os.path.join(SCRIPT_PATH, 'C:/final_project/FRCNN_HEW/fonts')
DEFAULT_OUTPUT_DIR = os.path.join(SCRIPT_PATH, 'C:/final_project/FRCNN_HEW/image-data')
...
def generate_hangul_images(label_file, fonts_dir, output_dir):
    ...
    for character in labels:
        ...
        for font in fonts:
            ...
            font = ImageFont.truetype(font, random.randint(11, 50))
            ...
            file_string = '{}{}.jpeg'.format(character, total_count)
...
#     indices = numpy.reshape(dy, (-1, 1)), numpy.reshape(dx, (-1, 1))
